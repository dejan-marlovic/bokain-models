class Phrase
{
  ...
  final Map<String, String> _phraseData =
  {
    ...
    "booking_completed_text" : "tryck utanför rutan för att fortsätta.",
    "booking_confirm" : "bekräfta bokning",
    "booking_confirm_text" :  "kontrollera att uppgifterna ovan stämmer och tryck SLUTFÖR för att bekräfta bokningen",
