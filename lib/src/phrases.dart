class Phrases
{
  static final Map<String, Map<String, String>> data =
  {
    "sv":
    {
      ...
      "_email_new_booking" : '<table class="text-center"><tr><th><h1 class="text-center">Bokningsbekräftelse</h1><h2 class="text-center">Hej %customer_name%!</h2><p class="text-center">Vi har tagit emot din bokning enligt nedan</p><h2 class="text-center">%service_name%</h2><h4 class="text-center">%service_addon_names%</h4><p class="text-center">%salon_name%<br/>%salon_address%</p><p class="text-center">%date%</p><p class="text-center">kl %start_time%-%end_time%</p><p class="text-center">Utövare: %user_name%</p><h4 class="text-center">Välkommen!</h4></tr></table>',
