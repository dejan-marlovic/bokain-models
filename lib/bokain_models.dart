// Copyright (c) BuyByMarcus Ltd, Patrick. All rights reserved. Use of this source code
...
export 'src/static_model/country.dart';
export 'src/static_model/language.dart';
export 'src/static_model/skin_type.dart';
...
export 'src/services/static/country_service.dart';
export 'src/services/static/language_service.dart';
export 'src/services/static/skin_type_service.dart';